...
PHOTON_NET_DEFAULT="photonboltxyz_photon"
ISSUER_API_DEFAULT="http://127.0.0.1:3001"
BITCOIND_CONTAINER_DEFAULT="photon-bitcoind"
MINE_ADDRESS_DEFAULT="bcrt1q4d9v3729r5wzll48wvj00vsa0eznjz5zz55jmh"
ASSET_ID_DEFAULT="rgb:2Mhfmuc0-BqWCUwP-kkJKF_V-F1~L4j6-A1_W6Yy-hK6Z~rA"
...
ASSET_ID="$(prompt_default 'RGB asset id' "$ASSET_ID_DEFAULT")"
...
MINE_ADDRESS="$(prompt_default 'Regtest mining address' "$MINE_ADDRESS_DEFAULT")"
